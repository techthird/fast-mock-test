        ...
        if (StringUtils.isNotBlank(genericFullyQualifiedName) && !CommonUtils.isJavaDataType(javaMethodModel.getGenericValue())) {
            if (genericFullyQualifiedName.contains(",")) {
                ...
                for (String name : nameArr) {
                    ...
                    if (name.contains("<")) {
                        javaGenericModel.setGenericName(name.substring(name.lastIndexOf(".") + 1, name.length()));
                        javaGenericModel.setGenericFullyQualifiedName(name.substring(name.lastIndexOf("<") + 1, name.length()));
                    } else {
                        javaGenericModel.setGenericName(name.substring(name.lastIndexOf(".") + 1, name.length()-1));
                        javaGenericModel.setGenericFullyQualifiedName(name.substring(0,name.lastIndexOf(">")));
                    }
                    javaGenericModelList.add(javaGenericModel);
                }
            }else if(genericFullyQualifiedName.contains("<")){
                JavaGenericModel javaGenericModel = new JavaGenericModel();
