...
import fast.mock.test.demo.mapper.UserTemplateMapper;
import fast.mock.test.demo.query.UserTemplateQueryBo;
import fast.mock.test.demo.service.IUserTemplateService;
import fast.mock.test.demo.entity.UserTemplate;
import fast.mock.test.demo.mapper.UserTemplateMapper;
import fast.mock.test.demo.service.IUserTemplateService;
...
public class UserTemplateServiceImpl extends ServiceImpl<UserTemplateMapper, UserTemplate> implements IUserTemplateService {
     ...
     * @param query
     */
    public boolean update222(UserTemplate entity,UserTemplateQueryBo query) {
        if(entity==null || query==null){
            return false;
        }
        return this.update(entity,query.buildQuery());
